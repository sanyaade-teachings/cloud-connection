...
//============================================================================================================
class PACCPTestGamePluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "PACCPTestGamePlugin";  // must match DLL name
  }
};

//  global plugin instance
PACCPTestGamePluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_PACCPTestGamePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_PACCPTestGamePlugin();}
...
void PACCPTestGamePluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("PACCPTestGamePluginClass:OnInitEnginePlugin()");
...
// load plugins if supported
  ...
  hkvLog::Debug("PACCPTestGameApplicationClass::Init() - start GPG");
  ...
  hkvLog::Debug("PACCPTestGameApplicationClass::Init() - end GPG");
...
void PACCPTestGamePluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("PACCPTestGamePluginClass:OnDeInitEnginePlugin()");
