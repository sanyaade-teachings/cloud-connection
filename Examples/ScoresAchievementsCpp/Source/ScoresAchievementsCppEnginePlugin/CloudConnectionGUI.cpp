...
void CloudConnectionGUI::InitGUI()
{
...
void CloudConnectionGUI::DeinitGUI()
{
...
void CloudConnectionGUI::ShowGUI()
{        
...
void CloudConnectionGUI::Update() 
{
	if ( spMainDlg != NULL ) 
  {      
    //Get the instance of the cloud connection client
...
void CloudConnectionGUI::OnHandleCallback( IVisCallbackDataObject_cl* pData ) 
{    
  //Get the instance of the cloud connection client
  CloudConnection* paccm = CloudConnection::GetInstance();
  VASSERT_MSG( paccm != NULL, "The Cloud Connection Module cannot be null" );
...
void CloudConnectionGUI::AuthenticationChanged()
{  
  if ( spMainDlg != NULL )
  {      
    //Get the instance of the cloud connection client
...
void CloudConnectionGUI::SetButtonStatus(const char* buttonID, bool enabled )
{
  if ( spMainDlg != NULL )
  {      
