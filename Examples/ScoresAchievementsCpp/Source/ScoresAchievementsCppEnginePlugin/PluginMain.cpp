...
//============================================================================================================
class ScoresAchievementsCppEnginePlugin : public IVisPlugin_cl
{
public:
  ...
  {
    return "ScoresAchievementsCppEnginePlugin";  // must match DLL name
  }
};

//  global plugin instance
ScoresAchievementsCppEnginePlugin g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_ScoresAchievementsCppEnginePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_ScoresAchievementsCppEnginePlugin();}
...
void ScoresAchievementsCppEnginePlugin::OnInitEnginePlugin()
{
  hkvLog::Info("ScoresAchievementsCppEnginePlugin:OnInitEnginePlugin()");
...
void ScoresAchievementsCppEnginePlugin::OnDeInitEnginePlugin()
{
  hkvLog::Info("ScoresAchievementsCppEnginePlugin:OnDeInitEnginePlugin()");
