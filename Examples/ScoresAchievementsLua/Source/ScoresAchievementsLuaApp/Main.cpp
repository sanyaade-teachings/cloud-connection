...
#include "ScoresAchievementsLuaAppPCH.h"
...
VIMPORT IVisPlugin_cl* GetEnginePlugin_ScoresAchievementsLuaEnginePlugin();

class ScoresAchievementsLuaApp : public VAppImpl
{
public:
  ScoresAchievementsLuaApp() {}
  virtual ~ScoresAchievementsLuaApp() {}
...
VAPP_IMPLEMENT_SAMPLE(ScoresAchievementsLuaApp);

void ScoresAchievementsLuaApp::SetupAppConfig(VisAppConfig_cl& config)
{
  ...
  */
  ...
  config.m_videoConfig.m_szWindowTitle = "ScoresAchievementsLua";

  config.m_videoConfig.m_bWaitVRetrace = true;
}

void ScoresAchievementsLuaApp::PreloadPlugins()
{
  ...
  VISION_PLUGIN_ENSURE_LOADED(ScoresAchievementsLuaEnginePlugin);
}

//---------------------------------------------------------------------------------------------------------
// Init function. Here we trigger loading our scene
//---------------------------------------------------------------------------------------------------------
void ScoresAchievementsLuaApp::Init()
{
...
//---------------------------------------------------------------------------------------------------------
void ScoresAchievementsLuaApp::AfterSceneLoaded(bool bLoadingSuccessful)
{
...
//---------------------------------------------------------------------------------------------------------
bool ScoresAchievementsLuaApp::Run()
{
  return true;
}

void ScoresAchievementsLuaApp::DeInit()
{
  // De-Initialization
  // [...]
}
