...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  g_VisionAppSettings.szAppBundleDirectory = [appBundlePath fileSystemRepresentation];
  g_VisionAppSettings.szLibraryDirectory = [libraryPath fileSystemRepresentation];
  ...
  g_VisionAppSettings.szAppBundleDirectory = NULL;
  g_VisionAppSettings.szLibraryDirectory = NULL;
