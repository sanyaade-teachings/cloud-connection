...
You should now also exclude any .java files from your Visual Studio project if you have any listed as they will now be compiled by the ANT build process instead.
